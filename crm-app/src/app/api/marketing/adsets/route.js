...
export async function GET() {
    try {
        ...
        const url = `https://graph.facebook.com/v19.0/${AD_ACCOUNT_ID}/adsets?fields=name,status,campaign_id,targeting,daily_budget,lifetime_budget,optimization_goal,insights.date_preset(maximum){spend,impressions,clicks,reach,cpc,cpm,ctr,actions,action_values,cost_per_action_type}&limit=100&access_token=${ACCESS_TOKEN}`;
