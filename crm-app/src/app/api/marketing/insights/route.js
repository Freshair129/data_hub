...
export async function GET() {
    try {
        ...
        const url = `https://graph.facebook.com/v19.0/${AD_ACCOUNT_ID}/insights?fields=spend,impressions,clicks,reach,actions,action_values&date_preset=last_30d&access_token=${ACCESS_TOKEN}`;
